          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {albums.map((album) => (
              <div key={album.id} className="group relative">
                ...
                >
                  <Card className="glass-card border-none hover:ring-4 ring-primary/20 transition-all duration-300 cursor-pointer overflow-hidden rounded-4xl shadow-sm hover:shadow-2xl hover:-translate-y-2 h-full flex flex-col min-w-0">
                    <div className="aspect-video bg-muted/30 relative flex items-center justify-center overflow-hidden shrink-0">
                    ...
                    <CardHeader className="p-6 flex-1 flex flex-col min-w-0 w-full overflow-hidden">
                      <TruncatedText 
                        text={album.title} 
                        className="text-xl font-bold group-hover:text-primary transition-colors duration-300 w-full"
                      />
